...
/**
  * Methods which each ConvertorContext has to implement.
  *
  * Convertor Context is a class which holds the state of connection/chunks and allows us to write to those chunks
  * via unified API
  */
trait ConvertorContext {
