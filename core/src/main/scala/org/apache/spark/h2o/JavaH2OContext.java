 ...
 */
    ...
    /** Pass-through to H2OContext.asH2OFrame.  For API support only.*/
    public H2OFrame asH2OFrame(DataFrame df, Option<String> frameName){
    ...
    public DataFrame asDataFrame(H2OFrame fr, SQLContext sqlContext){
        return hc.asDataFrame(fr, sqlContext);
    }
    ...
    public DataFrame asDataFrame(String key, SQLContext sqlContext){
        return hc.asDataFrame(key, sqlContext);
    }
